...
from src.training.model_ITE import model_graph
...
class Utils:
    ...
    def load_data(self):
        ...
        interact_mat = data_utils.load_interact_matrix(
            self.root_path + self.hyper_params["data_scene"] + "_train.rating", num_user,
            num_item)
        test_data = data_utils.load_test_data(self.root_path + self.hyper_params["data_scene"] + "_test.rating")
        negative_data = data_utils.load_negative_data(
            self.root_path + self.hyper_params["data_scene"] + "_test.negative")
